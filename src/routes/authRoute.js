...
authRoute.post('/reset-password', verifyAccessToken, resetPassword); // when the user wants to reset their password with a new one
authRoute.get('/change-password', changePassword); // this is used by the backend alone!
